  ...
  -- 1. Hacker Dashboard + Boot Animation
  {
    ...
    config = function(_, opts)
      ...
      vim.api.nvim_create_autocmd("UIEnter", {
        once = true,
        callback = function()
          if vim.g.colors_name ~= "hackerman" then return end
          ...
          vim.defer_fn(function()
            ...
            local win = vim.api.nvim_open_win(buf, true, {
              relative = "editor",
              width = w, height = h, col = 0, row = 0,
              style = "minimal", zindex = 300,
            })
            vim.api.nvim_set_option_value("winhl", "Normal:HackermanBoot", { win = win })

            local blank = {}
            for _ = 1, h do blank[#blank + 1] = "" end
            ...
            for i, line in ipairs(lines) do
              ...
              vim.cmd("redraw")
              r = r + 1
              if i < #lines then vim.cmd("sleep 150m") end
            end
  ...
  -- 3. All hackerman visual effects
  {
    ...
    config = function()
      ...
      local function is_code_buf(buf)
        ...
        if fx_blacklist[vim.bo[buf].filetype] then return false end
        return true
      end
      ...
      vim.api.nvim_create_autocmd("BufReadPost", {
        callback = function(args)
          ...
          vim.defer_fn(function()
            ...
            -- Random reveal order
            local order = {}
            for i = 0, line_count - 1 do order[#order + 1] = i end
            for i = #order, 2, -1 do
      ...
      vim.api.nvim_create_autocmd("BufWritePost", {
        callback = function(args)
          ...
          timer:start(0, 22, vim.schedule_wrap(function()
      ...
      vim.api.nvim_create_autocmd("DiagnosticChanged", {
        callback = function(args)
          ...
          local float_win = vim.api.nvim_open_win(float_buf, false, {
            ...
            style = "minimal", border = "none", zindex = 200,
          })
